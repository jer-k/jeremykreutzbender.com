...
An update to my post on [adding a testing environment to a gem](https://jer-k.github.io/testing-and-developer-scripts-for-active-record-gem/). After doing some recent updates to our Docker
...
![gem_with_database_git_diff](/post_images/gem_with_database_alpine_changes.png)
