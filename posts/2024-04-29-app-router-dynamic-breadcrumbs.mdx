...
had just landed in Next.js.The Pull Request he linked is
[support breadcrumb style catch-all parallel routes](https://github.com/vercel/next.js/pull/65063)
by [ztanner](https://github.com/ztanner), a [Vercel](https://vercel.com) employee and [Next.js](https://nextjs.org/)
maintainer.

The Pull Request added functionality and demonstrates how to use the
...
build out our breadcrumbs, we'll want to use a
[catch-all segment](https://nextjs.org/docs/app/building-your-application/routing/dynamic-routes#catch-all-segments)
...
A note when using Parallel Routes is that a
[default](https://nextjs.org/docs/app/building-your-application/routing/parallel-routes#defaultjs)
